...
/// meter manufacturer code and software and hardware version
public struct TCB11MeterModel: TCB11Model {
...
extension TCB11MeterModel: TCBBaseModelConvertable {
    public typealias Output = Self
    
    public static func convert(from data: [UInt8]) -> TCB11MeterModel {
        var model = Self()
        
        model.manufacturerCode = Array(data.prefix(4)).asciiToString()
        ...
        model.meterID = Array(data.suffix(from: 8)).toHexString()
        return model
    }
