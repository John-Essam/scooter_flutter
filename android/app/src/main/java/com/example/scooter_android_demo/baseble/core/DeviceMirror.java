package com.example.scooter_android_demo.baseble.core;
...
import com.example.scooter_android_demo.baseble.callback.IRssiCallback;
import com.example.scooter_android_demo.baseble.common.BleConfig;
import com.example.scooter_android_demo.baseble.common.BleConstant;
import com.example.scooter_android_demo.baseble.common.ConnectState;
...
import com.example.scooter_android_demo.baseble.exception.ConnectException;
import com.example.scooter_android_demo.baseble.exception.GattException;
import com.example.scooter_android_demo.baseble.exception.TimeoutException;
import com.example.scooter_android_demo.baseble.model.BluetoothLeDevice;
import com.example.scooter_android_demo.baseble.utils.HexUtil;
import com.example.scooter_android_demo.baseble.utils.ViseLog;
...
import static com.example.scooter_android_demo.baseble.common.BleConstant.MSG_CONNECT_RETRY;
import static com.example.scooter_android_demo.baseble.common.BleConstant.MSG_CONNECT_TIMEOUT;
import static com.example.scooter_android_demo.baseble.common.BleConstant.MSG_READ_DATA_RETRY;
import static com.example.scooter_android_demo.baseble.common.BleConstant.MSG_READ_DATA_TIMEOUT;
import static com.example.scooter_android_demo.baseble.common.BleConstant.MSG_RECEIVE_DATA_RETRY;
import static com.example.scooter_android_demo.baseble.common.BleConstant.MSG_RECEIVE_DATA_TIMEOUT;
import static com.example.scooter_android_demo.baseble.common.BleConstant.MSG_WRITE_DATA_RETRY;
import static com.example.scooter_android_demo.baseble.common.BleConstant.MSG_WRITE_DATA_TIMEOUT;
...
public class DeviceMirror {
    ...
    private BluetoothGattCallback coreGattCallback = new BluetoothGattCallback() {
        ...
        public void onMtuChanged(BluetoothGatt gatt, int mtu, int status) {
            ViseLog.i("onMtuChanged status: " + status + " ,mtu: " + mtu +
                    "  ,thread: " + Thread.currentThread());
        }
    };
    ...
    public void writeData(byte[] data) {
        ...
        if (data.length > 512) {
            ViseLog.e("this data length beyond 512 byte.");
            return;
        }
        ...
        if (bluetoothLeDevice != null && bluetoothLeDevice.getDevice() != null) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                bluetoothGatt = bluetoothLeDevice.getDevice().connectGatt(ViseBle.getInstance().getContext(),
                        false, coreGattCallback, BluetoothDevice.TRANSPORT_LE);
            } else {
                bluetoothGatt = bluetoothLeDevice.getDevice().connectGatt(ViseBle.getInstance().getContext(),
